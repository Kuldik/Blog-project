...
var _UserController = _interopRequireDefault(require("./UserController.js"));

var _PostController = _interopRequireDefault(require("./PostController.js"));
...
fs.readdirSync(normalizedPath).forEach(function (file) {
  if (file !== 'index.js') {
    var controller = require("./controllers/".concat(file));
